...
return {
	{
		...
		opts = {
			...
			spec = {
				...
				{ "g", group = "goto", icon = { icon = " ", color = "azure" } },
				{ "z", group = "fold", icon = { icon = "", color = "cyan" } },
				{ "<leader>B", group = "bases", icon = { icon = " ", color = "blue" } },
				{ "<leader>[", group = "swap prev", icon = { icon = " ", color = "orange" } },
				{ "<leader>]", group = "swap next", icon = { icon = " ", color = "orange" } },
				{ "<leader>b", group = "buffer", icon = { icon = " ", color = "white" } },
				{ "<leader>c", group = "code", icon = { icon = "󰘦 ", color = "blue" } },
				{ "<leader>d", group = "debug", icon = { icon = " ", color = "red" } },
				{ "<leader>f", group = "find", icon = { icon = " ", color = "yellow" } },
				{ "<leader>h", group = "hunks", icon = { icon = " ", color = "green" } },
