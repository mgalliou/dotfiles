...
set -l linuxbrew_completions /home/linuxbrew/.linuxbrew/share/fish/vendor_completions.d/
if not contains $linuxbrew_completions $fish_complete_path
    set -ga fish_complete_path $linuxbrew_completions
end
